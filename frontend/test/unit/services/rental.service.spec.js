...
describe('rentalService', () => {
  ...
  it('list chama GET /rentals e retorna dados', async () => {
  ...
  it('create chama POST /rentals com payload correto', async () => {
  ...
  it('returnRental chama PUT /rentals/:id com payload', async () => {
  ...
  it('remove chama DELETE /rentals/:id', async () => {
